...
class _FadeInRightState extends State<FadeInRight> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
        ...
        return VisibilityDetector(
          ...
          child: FadeTransition(
            ...
            child: Transform.translate(
              offset: Offset((widget.offset ?? 50) * (1 - _animation.value), 0),
