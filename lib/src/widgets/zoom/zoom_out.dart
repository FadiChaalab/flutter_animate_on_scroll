...
class _ZoomOutState extends State<ZoomOut> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  /// Animation, used to animate the scale
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(begin: 1.0, end: widget.zoom ?? 0.3).animate(
      CurvedAnimation(
        parent: _animationController,
        curve: widget.config.curves ?? Curves.decelerate,
      ),
