...
class RotateInDownRight extends StatefulWidget {
  ...
  @override
  State<RotateInDownRight> createState() => _RotateInDownRightState();
}

class _RotateInDownRightState extends State<RotateInDownRight> with SingleTickerProviderStateMixin {
