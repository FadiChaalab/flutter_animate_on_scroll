...
class RotateOutUpRight extends StatefulWidget {
  ...
  /// provide degree if need it, by default -90
  final double? degree;
  ...
  @override
  State<RotateOutUpRight> createState() => _RotateOutUpRightState();
}

class _RotateOutUpRightState extends State<RotateOutUpRight> with SingleTickerProviderStateMixin {
      ...
      builder: (context, child) {
        return FadeTransition(
          ...
          child: Transform.rotate(
            angle: widget.degree ?? -90 * toRad * (1 - _animation.value),
