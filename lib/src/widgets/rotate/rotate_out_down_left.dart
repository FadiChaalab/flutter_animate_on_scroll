...
class RotateOutDownLeft extends StatefulWidget {
  ...
  @override
  State<RotateOutDownLeft> createState() => _RotateOutDownLeftState();
}

class _RotateOutDownLeftState extends State<RotateOutDownLeft> with SingleTickerProviderStateMixin {
