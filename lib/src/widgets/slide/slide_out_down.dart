...
class SlideOutDown extends StatefulWidget {
  ...
  @override
  State<SlideOutDown> createState() => _SlideOutDownState();
}

class _SlideOutDownState extends State<SlideOutDown> with SingleTickerProviderStateMixin {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Transform.translate(
          offset: Offset(
            0,
            -(widget.offset ?? MediaQueryData.fromView(View.of(context)).size.height * 2 + _size.value.height) *
                (1 - _animation.value),
          ),
          child: Container(
